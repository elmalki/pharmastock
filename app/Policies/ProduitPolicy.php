...
class ProduitPolicy
{
    ...
    {
        return $user->hasPermissionTo('Lister Produit');
    }
    ...
    {
        return $user->hasPermissionTo('Créer Produit');;
    }
    ...
    {
        return $user->hasPermissionTo('Modifier Produit');;
    }
    ...
    {
        return $user->hasPermissionTo('Supprimer Produit');;
    }
