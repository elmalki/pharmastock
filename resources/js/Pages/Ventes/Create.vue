                ...
                <div class="">
                    <div class="mt-3 grid grid-cols-1 gap-x-3 gap-y-3 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <DatePicker  v-model="form.date" date-format="yy-mm-dd" class="w-full"></DatePicker>
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Numéro
                                Facture</label>
                            <div class="mt-2">
                                <InputText v-model="form.n_facture" id="n_facture"
                                           class="block w-full"></InputText>
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="first-name" class="block text-sm/6 font-medium text-gray-900">
                                Remise</label>
                            <div class="mt-2">
                                <InputText v-model="form.remise" id="n_facture"
                                           class="block w-full"></InputText>
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="last-name" class="block text-sm/6 font-medium text-gray-900">Mode de
                                paiement</label>
                            <Select :options="modes"  v-model="form.paiement" class="w-full"></Select>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Date
                                Echéance</label>
                                <DatePicker  v-model="form.dateEcheance" date-format="yy-mm-dd" class="w-full"></DatePicker>
                        </div>
                    </div>
                </div>
            </div>
